...
<body>
    ...
    <p><fmt:message key="description"></fmt:message></p>
    <p><fmt:message key="guide"></fmt:message></p>
    <div><a href="organization/newOrganization.html"><fmt:message key="org.registerOrg"></fmt:message></a></div>
